...
/**
 * EventBridge publisher for BillEvent
 * Generated by OpenAPI Generator
 */
export class BillEventPublisher {
    ...
    constructor(config: PublisherConfig = {}) {
        ...
        this.source = config.source || process.env.EVENT_SOURCE || 'com.homebound.billevent';
    }
     ...
     */
    async publish(event: BillEvent, detailType: string): Promise<any> {
        const serializedEvent = ObjectSerializer.serialize(event, 'BillEvent', 'json');
