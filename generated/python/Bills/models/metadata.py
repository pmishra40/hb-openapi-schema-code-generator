...
class Metadata(BaseModel):
    ...
    event_time_stamp: datetime = Field(description="ISO 8601 UTC date-time format (YYYY-MM-DDThh:mm:ss.sssZ)", alias="eventTimeStamp")
    schema_version: StrictStr = Field(alias="schemaVersion")
    __properties: ClassVar[List[str]] = ["idempotencyKey", "correlationId", "eventTimeStamp", "schemaVersion"]
